...
*Отчет обновлен 23 января 2025 на основе комплексной проверки всех компонентов системы после реализации Read Model Builder и Event Sourcing архитектуры.* 