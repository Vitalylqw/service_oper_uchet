...
Usage:
    ...
    python scripts/services/run_sync_snapshot_dashboard.py --sync-type full
    python scripts/services/run_sync_snapshot_dashboard.py --snapshot-label "my_label"
    python scripts/services/run_sync_snapshot_dashboard.py --skip-sync
"""
...
def main() -> int:
    ...
    snapshot_cmd = [
        python,
        str(PROJECT_ROOT / "scripts" / "services" / "create_db_snapshot.py"),
    ]
    ...
    dashboard_cmd = [
        python,
        str(PROJECT_ROOT / "scripts" / "services" / "generate_dashboard.py"),
        "--mode", "compare",
    ]
