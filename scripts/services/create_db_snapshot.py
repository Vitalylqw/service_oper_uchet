...
Usage:
    python scripts/services/create_db_snapshot.py --label "before_sync"
    python scripts/services/create_db_snapshot.py --label "after_sync"
    python scripts/services/create_db_snapshot.py  # auto-generated label
"""
