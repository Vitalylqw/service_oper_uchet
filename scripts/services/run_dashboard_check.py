...
Usage:
    ...
    python scripts/services/run_dashboard_check.py --label "test_v1"

    # Before/after workflow
    python scripts/services/run_dashboard_check.py --before "sync_test"
    # ... run your test ...
    python scripts/services/run_dashboard_check.py --after "sync_test"
